...
//  BTService.swift
//  Arduino_Servo
// the code used from https://www.raywenderlich.com/85900/arduino-tutorial-integrating-bluetooth-le-ios-swift
// created by Owen L Brown
...
let BLEServiceUUID = CBUUID(string: "00001101-0000-1000-8000-00805F9B34FB")
//let PositionCharUUID = CBUUID(string: "F38A2C23-BC54-40FC-BED0-60EDDA139F47")
let PositionCharUUID = CBUUID(string: "00001101-0000-1000-8000-00805F9B34FB")
